    ...
    <div className="min-h-screen bg-[#FAF5EF] text-[#333333]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[90vh]">
        ...
        <div className="relative bg-white border-b lg:border-b-0 lg:border-r border-[#E0E0E0] flex items-center justify-center min-h-[70vw] md:min-h-[50vw] lg:min-h-0 lg:sticky lg:top-24 lg:h-[calc(100vh-6rem)]">
          ...
          <p className="absolute bottom-4 left-1/2 -translate-x-1/2 text-[9px] tracking-widest uppercase text-[#CCCCCC] whitespace-nowrap">
            Drag to rotate
          </p>
        </div>
        ...
        <div className="px-5 md:px-10 lg:px-12 py-8 lg:py-14 flex flex-col bg-[#FAF5EF]">
          ...
          <div className="mb-6">
            <p className="text-[10px] tracking-widest uppercase text-[#AAAAAA] mb-3">
              Color — <span className="text-[#333333]">Original</span>
            </p>
                  ...
                  <thead>
                    <tr className="border-b border-[#E0E0E0]">
                      {["Size", "Chest", "Length", "Sleeve"].map((h) => (
                        <th key={h} className="text-[9px] tracking-widest uppercase text-[#AAAAAA] text-left py-2 pr-4 font-medium">
                          {h}
                        </th>
                      ))}
                    </tr>
        ...
        <div className="border-t border-[#E0E0E0] px-4 md:px-8 py-12 md:py-16 bg-white">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tighter text-[#333333]">
                You May Also Like
              </h2>
            </div>
            <Link
