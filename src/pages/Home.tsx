  ...
  return (
    <main className="bg-[#FAF5EF] text-[#333333] overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative flex flex-col lg:flex-row overflow-hidden" style={{ minHeight: "100svh" }}>
        ...
        {/* ── 3D Viewer (mobile: first, desktop: right) ── */}
        <div className="order-1 lg:order-2 relative w-full lg:w-1/2 bg-white border-b lg:border-b-0 lg:border-l border-[#E0E0E0] overflow-hidden"
          ...
          <div
            ...
            style={{
              background: `radial-gradient(ellipse at 50% 60%, ${heroProducts[currentSlide]?.color || "#7EC8E3"}22, transparent 65%)`,
            }}
          />
          ...
          {/* SVG Model — fills container properly */}
          <div
          ...
          >
            <div style={{
              width: "clamp(140px, 42vw, 340px)",
              height: "clamp(180px, 54vw, 440px)",
            }}>
              <ModelViewer
            ...
            <div className="bg-white/95 border border-[#E0E0E0] p-3 md:p-4" style={{ backdropFilter: "blur(8px)" }}>
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="text-right shrink-0">
                  ...
                  <Link
                    to={`/product/${heroProducts[currentSlide]?.id}`}
                    className="text-[9px] tracking-widest uppercase text-[#7EC8E3] hover:underline"
                  >
                    View →
                  </Link>
                </div>
                ...
                {heroProducts.map((_, i) => (
                  <button
                    ...
                    className={`transition-all duration-300 rounded-full ${
                      i === currentSlide
                        ? "w-5 h-1.5 bg-[#7EC8E3]"
                        : "w-1.5 h-1.5 bg-[#E0E0E0] hover:bg-[#AAAAAA]"
                    }`}
                  />
                ))}
        ...
        >
          ...
          <p className="text-[9px] tracking-[0.5em] text-[#AAAAAA] uppercase mb-2 md:mb-3">
            New Collection 2026
          </p>

          <h1
            className="font-black tracking-tighter text-[#333333] leading-none mb-4 md:mb-5"
            style={{ fontSize: "clamp(52px, 10vw, 112px)" }}
          >
            DRIP<span className="text-[#7EC8E3]">.</span>
          </h1>

          <p className="text-[#888888] leading-relaxed mb-5 md:mb-7 max-w-xs md:max-w-sm"
          ...
          <div className="flex gap-5 md:gap-8 mb-5 md:mb-8 pb-5 md:pb-8 border-b border-[#E0E0E0]">
            {[
              ...
              <div key={stat.label}>
                <p className="font-bold text-[#333333]" style={{ fontSize: "clamp(18px, 3vw, 26px)", color: stat.color }}>
                  {stat.value}
                </p>
          ...
          <div className="flex flex-col sm:flex-row gap-2 md:gap-3 mb-5 md:mb-8">
            <Link
              to="/shop"
              className="px-6 md:px-8 py-3 md:py-3.5 bg-[#333333] text-white text-[10px] tracking-widest uppercase hover:bg-[#7EC8E3] transition-all duration-300 text-center font-medium"
            >
              Shop Collection
            </Link>
            <Link
              to="/collections"
              className="px-6 md:px-8 py-3 md:py-3.5 border border-[#DDD5C7] text-[#333333] text-[10px] tracking-widest uppercase hover:border-[#7EC8E3] hover:text-[#7EC8E3] transition-all duration-300 text-center"
            >
              View Collections
            </Link>
          </div>
          ...
          {featured.map((product, i) => (
            ...
            >
              <div className={`bg-white border border-[#E0E0E0] group-hover:border-[#7EC8E3] transition-all duration-500 overflow-hidden relative ${
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/95 to-transparent p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="mt-1.5 px-0.5">
                <p className="text-[9px] md:text-[10px] text-[#333333] group-hover:text-[#7EC8E3] transition-colors truncate font-medium">
                  {product.name}
                </p>
      ...
      <section className="border-t border-[#E0E0E0]">
        <div className="grid grid-cols-1 md:grid-cols-2">
          {[
            {
              to: "/shop", label: "Men",
              bg: "bg-[#F4F4F4]", hoverColor: "#7EC8E3",
            ...
            {
              to: "/shop", label: "Women",
              bg: "bg-[#FFF8F0]", hoverColor: "#FF6B6B",
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <span
                  className="inline-flex items-center gap-2 text-[9px] tracking-widest uppercase border-b pb-0.5 transition-all duration-300 text-[#333333] border-[#333333]"
                  style={{ ["--hover" as string]: item.hoverColor }}
                >
                  Shop {item.label}
      ...
      {/* ── NEW ARRIVALS ── */}
      <section className="px-4 md:px-8 py-10 md:py-20 bg-white border-t border-[#E0E0E0]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
          {newArrivals.map((product) => (
            <Link key={product.id} to={`/product/${product.id}`} className="group">
              <div className="bg-[#FAF5EF] border border-[#E0E0E0] group-hover:border-[#7EC8E3] transition-all duration-500 overflow-hidden relative mb-2"
      ...
      {/* ── CATEGORIES ── */}
      <section className="px-4 md:px-8 py-10 md:py-16 border-t border-[#E0E0E0] bg-[#FAF5EF]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
          {[
            ...
            >
              ...
              <p className="text-[8px] tracking-widest uppercase mb-0.5 font-medium" style={{ color: cat.accent }}>
                {cat.count}
              </p>
              <p className="text-xs md:text-sm font-bold tracking-tight text-[#333333] group-hover:translate-x-0.5 transition-transform duration-300">
                {cat.name}
              </p>
      ...
      <section className="border-t border-[#E0E0E0] bg-[#2a2a2a] text-white px-5 md:px-12 py-12 md:py-24 overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <Link
            to="/shop"
            className="inline-block px-7 md:px-10 py-3 md:py-4 bg-[#7EC8E3] text-white text-[10px] tracking-widest uppercase hover:bg-white hover:text-[#333333] transition-all duration-300 font-medium"
          >
            Explore in 3D
          </Link>
        </div>
      ...
      <section className="px-5 py-14 md:py-28 text-center border-t border-[#E0E0E0] bg-[#FAF5EF] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/shop"
              className="px-8 md:px-10 py-3 md:py-4 bg-[#333333] text-white text-[10px] tracking-widest uppercase hover:bg-[#7EC8E3] transition-colors duration-300 font-medium"
            >
              Shop Now
            </Link>
            <Link
              to="/collections"
              className="px-8 md:px-10 py-3 md:py-4 border border-[#DDD5C7] text-[#333333] text-[10px] tracking-widest uppercase hover:border-[#333333] transition-colors duration-300"
            >
              Our Collections
            </Link>
          </div>
