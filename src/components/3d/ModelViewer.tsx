...
function Shadow({ animated }: { animated: boolean }) {
  return (
    <div style={{
      position: "absolute",
      bottom: "2%",
  ...
  return (
    <div data-model-root style={{ width: "100%", height: "100%", position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <SVGWrapper viewBox="0 0 200 275" animClass="sway" animate={animate}>
        ...
        {/* HEART */}
        <path d="M94 144 C92 139 85 139 85 145 C85 149 94 157 100 160 C106 157 115 149 115 145 C115 139 108 139 106 144 C104 141 102 139 100 139 C98 139 96 141 94 144Z"
          fill={s} opacity="0.75" style={{ animation: "twinkle 2s ease-in-out infinite" }}/>
